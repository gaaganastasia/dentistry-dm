      ...
      <div className='staff__container'>
        <Fade right>
          <div className='staff__block'>
            ...
            <Link to="/expert/5fcc6ff4-3328-4df3-86a0-d84aec5ece4d" className='staff__name'>Нимаев Баир Цыденович</Link>
          ...
          <div className='staff__block'>
            ...
            <Link to="/expert/44bfe6f7-2d8c-4e42-a3d3-530b439ed5f5" className='staff__name'>Нимаев Аюр Баирович</Link>
          ...
          <div className='staff__block'>
            ...
            <Link to="/expert/78a9680a-c29e-4c86-83ed-d2edc008decf" className='staff__name'>Нимаева Евгения Владимировна</Link>
        ...
        <Fade bottom>
          <div className='staff__block'>
            ...
            <Link to="/expert/3f11baac-ff21-4416-8909-793e645631c7" className='staff__name'>Петрова Маргарита Юрьевна</Link>
          ...
          <div className='staff__block'>
            ...
            <Link to="/expert/e3585a2a-e6b2-475f-9a0d-278308a3585c" className='staff__name'>Елизарова Елена Эдуардовна</Link>
